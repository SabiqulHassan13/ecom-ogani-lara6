...
<head>
    ...
    <title>Ogani | @yield('page-title')</title>
...
<body>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Powered by <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
  | Design & Developed <i class="fa fa-heart" aria-hidden="true"></i> by <a href="" target="_blank">Sabiqul Hassan</a>
